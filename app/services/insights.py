...
class InsightsService:
    ...
    def summary(self, country: str | None = None) -> InsightsSummary:
        return InsightsSummary(
            by_country=self.country_insights(),
            by_job_title_country=self.job_title_insights(),
            salary_distribution=self.salary_distribution(country=country),
            top_roles_by_country=self.top_roles_by_country(),
        )
